...
const TentangKamiPage = () => {
  return (
    // Background dibuat putih bersih (clean) untuk light mode, dan abu-abu sangat gelap untuk dark mode
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-500 font-sans text-gray-800 dark:text-gray-300">
      ...
      <main className="max-w-6xl mx-auto px-6 md:px-12 pt-32 pb-20">
        ...
        <section className="mb-20">
          <h1 className="text-4xl md:text-5xl font-serif text-gray-900 dark:text-white mb-12">
            Tentang Kami
          </h1>
          
          <div className="space-y-6 text-base md:text-[15px] leading-[1.8] text-gray-700 dark:text-gray-300 max-w-5xl">
            <p>
            ...
            <p>
              Namun, sebuah lembaga pendidikan sejati tidak pernah berhenti berkembang. Dunia terus bergerak, tuntutan zaman semakin beragam, dan kebutuhan anak-anak generasi hari ini semakin kompleks. Dibutuhkan langkah baru, visi yang lebih kuat, serta komitmen yang lebih jelas agar pondok mampu memberikan pengalaman belajar yang tidak hanya relevan, tetapi juga berdampak langsung terhadap perkembangan murid.
            </p>
            <p>
              Karena itulah, estafet kepemimpinan terus dilanjutkan. Perubahan ini bukanlah sekadar pergantian yayasan atau formalitas administratif, melainkan bagian dari upaya strategis untuk memperkokoh fondasi pendidikan. Pondok Pesantren Cendekia memasuki babak baru: memperkuat kualitas pembelajaran, menghadirkan program penunjang yang lebih maksimal, dan memastikan setiap kebijakan benar-benar menyentuh kebutuhan santri serta keluarga mereka.
            </p>

            {/* FOTO LEBAR (LANDSCAPE) DI TENGAH TEKS */}
            <div className="w-full my-12 rounded-2xl md:rounded-[2rem] overflow-hidden bg-gray-100 dark:bg-gray-800">
              <img 
            ...
            <p>
              Komitmen yang dibawa juga menekankan pentingnya kolaborasi erat antara pondok dan orang tua. Kami percaya, pendidikan yang utuh tidak hanya berlangsung di ruang kelas, tetapi juga di rumah. Karena itu, program monitoring ibadah dan pendampingan belajar menjadi salah satu bentuk nyata keterlibatan orang tua dalam mendukung tumbuh kembang anak. Dengan sinergi yang baik, setiap langkah kecil anak menjadi bagian dari perjalanan besar menuju masa depan yang penuh cahaya.
            </p>
            <p>
        ...
        <section className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center mb-16 md:mb-24">
            <div className="order-2 md:order-1">
              ...
              <p className="text-gray-700 dark:text-gray-300 text-base md:text-[17px] leading-relaxed">
            ...
            <div className="order-1 md:order-2 w-full h-[250px] md:h-[350px] rounded-[2rem] overflow-hidden bg-gray-100 dark:bg-gray-800">
               <img 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
            <div className="w-full h-[300px] md:h-[450px] rounded-[2rem] overflow-hidden bg-gray-100 dark:bg-gray-800">
              <img 
            ...
            <div>
              ...
              <ol className="list-decimal pl-5 space-y-4 text-gray-700 dark:text-gray-300 text-sm md:text-[15px] leading-relaxed marker:font-bold marker:text-gray-900 dark:marker:text-white">
