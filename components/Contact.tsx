            ...
            <div className="space-y-6">
              ...
              <div className="animate-on-scroll-contact opacity-0 translate-y-20 transition-all duration-1000 ease-out delay-300 bg-white dark:bg-gray-900 p-7 rounded-[1.5rem] border border-gray-100 dark:border-gray-700 flex gap-6 group hover:shadow-lg hover:border-emerald-200 transition-all">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-xs md:text-sm mb-2"><span className="font-semibold text-gray-800 dark:text-gray-100">Senin - Jum'at:</span> 08.00 - 15.00 WIB</p>
                  <p className="text-xs md:text-sm text-emerald-800 dark:text-emerald-400 font-semibold leading-relaxed">Jadwal Kunjungan Wali Santri:<br />Setiap Ahad (Minggu) pekan ke-2 & ke-4.</p>
                </div>
              </div>
